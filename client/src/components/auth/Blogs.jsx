            ...
            content: {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        content: `• Tưới vào đất, không tưới lên lá: Hạn chế việc để nước đọng trên lá, đặc biệt ở phần lõi.

                        • Sử dụng chậu có lỗ thoát nước: Điều kiện bắt buộc!
                        
                        • Sử dụng đất thoát nước tốt: Chọn đất chuyên dụng hoặc trộn với perlite, pumice, xỉ than.
                        
                        • Không phun sương: Phun sương không cung cấp đủ nước cho rễ và tạo điều kiện cho nấm phát triển.
                        
                        • Tưới "đẫm" nhưng không "ngâm": Đảm bảo nước chảy ra khỏi lỗ thoát nước.`
                    },
                    {
                        id: 'dau-hieu-sai-cach',
                        title: 'Dấu hiệu của việc tưới nước sai cách',
                        content: `Úng nước (Overwatering):
                        • Lá chuyển màu vàng, nhũn, trong mờ và mềm
                        • Lá dễ rụng khi chạm vào
                        • Thân cây mềm nhũn, có đốm đen hoặc nâu
                        • Có mùi hôi từ đất
                        
                        Thiếu nước (Underwatering):
                        • Lá teo tóp, nhăn nheo, khô lại và giòn
                        • Cây có vẻ yếu ớt, không căng mọng
                ...
                sections: [
                    {
                        ...
                        📺 [Xem video hướng dẫn tại đây](https://youtu.be/C7ytQoOSN2I)
                    ...
                    },
                    {
                        ...
                        Mẹo nhận biết:
                        • Quan sát hình dáng tổng thể của cây
                        • Chú ý đến màu sắc và texture của lá
                        • Xem cách lá xếp chồng lên nhau
                        • Kiểm tra có lông tơ hay không`
                    },
                    {
                        id: 'cach-phan-biet',
                        title: 'Cách phân biệt các loại sen đá tương tự',
                        content: `Echeveria vs Sempervivum:
                        • Echeveria: Lá mịn, bóng, không có lông
                        • Sempervivum: Thường có lông mịn, chịu lạnh tốt hơn

                        Sedum vs Crassula:
                        • Sedum: Lá thường nhỏ, mọc xen kẽ
                        • Crassula: Lá mọc đối xứng, dày hơn

                        Haworthia vs Aloe nhỏ:
                        • Haworthia: Lá có đốm trắng, không gai
                        • Aloe: Lá có gai nhỏ ở viền
                ...
                sections: [
                    {
                        ...
                        Nội dung video bao gồm:
                        • Cách chọn lá khỏe mạnh để nhân giống
                        • Kỹ thuật tách chồi bên an toàn
                        • Phương pháp chia cụm đúng cách
                        • Chuẩn bị đất và môi trường phù hợp

                        📺 [Xem video hướng dẫn tại đây](https://youtu.be/QgtHwOEW1VU)
                    ...
                    },
                    {
                        ...
                        Bước 1: Chọn lá
                        • Chọn lá khỏe mạnh, đầy đặn từ cây mẹ
                        • Lá phải còn nguyên vẹn, không bị thương tổn
                        • Bứt lá từ gốc một cách nhẹ nhàng, đảm bảo có đầu lá

                        Bước 2: Để khô vết thương
                        • Để lá ở nơi khô ráo, thoáng mát 2-3 ngày
                        • Vết bứt cần khô hoàn toàn để tránh thối

                        Bước 3: Đặt lên đất
                        • Dùng đất chuyên dụng cho sen đá hoặc đất cát pha
                        • Đặt lá lên bề mặt đất, không chôn sâu
                        • Giữ độ ẩm vừa phải cho đất

                        Bước 4: Chăm sóc và chờ đợi
                        • Phun sương nhẹ 2-3 ngày/lần
                        • Sau 2-4 tuần sẽ xuất hiện rễ và chồi non
                        • Khi cây con đủ lớn (3-5cm) có thể tách riêng
                    ...
                    },
                    {
                        ...
                        • Chồi bên mọc từ thân chính của cây mẹ
                        • Chọn chồi đã có kích thước ít nhất 2-3cm
                        • Đảm bảo chồi có hệ rễ riêng hoặc điểm phát rễ

                        Bước 2: Tách chồi
                        • Dùng dao sắc, khử trùng để cắt chồi
                        • Cắt sát gốc, để lại một chút thân gốc
                        • Tránh làm tổn thương cây mẹ

                        Bước 3: Xử lý vết cắt
                        • Rắc bột quế hoặc than hoạt tính lên vết cắt
                        • Để khô 1-2 ngày ở nơi thoáng mát
                        • Quan sát vết cắt có khô ráo không

                        Bước 4: Trồng chồi mới
                        • Trồng vào chậu nhỏ với đất tơi xốp
                        • Tưới nước nhẹ, tránh úng
                        • Đặt ở nơi sáng nhưng không ánh sáng trực tiếp
                    ...
                    },
                    {
                        ...
                        Bước 1: Chuẩn bị
                        • Ngừng tưới nước 3-5 ngày trước khi chia
                        • Chuẩn bị chậu mới và đất sạch
                        • Khử trùng dụng cụ cắt

                        Bước 2: Lấy cây ra khỏi chậu
                        • Lật úp chậu, nhẹ nhàng lấy cây ra
                        • Giũ sạch đất cũ ở rễ
                        • Quan sát hệ rễ và điểm chia

                        Bước 3: Chia cụm
                        • Tách từng cây con có rễ riêng
                        • Có thể dùng dao để cắt nếu cần thiết
                        • Mỗi cây con cần có ít nhất 2-3 lá và một ít rễ

                        Bước 4: Trồng riêng
                        • Trồng mỗi cây vào chậu riêng
                        • Dùng đất mới, tơi xốp
                        • Tưới nước nhẹ sau 2-3 ngày

                        Thời gian phục hồi: 1-2 tuần
                        Tỷ lệ thành công: 95-98%

                        Lưu ý quan trọng:
                        • Thực hiện vào mùa xuân hoặc đầu mùa hè
                        • Tránh chia cụm khi cây đang ra hoa
                        • Theo dõi cây sát trong 2 tuần đầu`
                    },
                    {
                        id: 'luu-y-chung',
                        ...
                        • Nhiệt độ: 18-25°C
                        • Độ ẩm: 40-60%
                        • Ánh sáng: Sáng nhưng không trực tiếp
                        • Thông gió tốt

                        Đất trồng:
                        • Đất cát pha với perlite (tỷ lệ 1:1)
                        • Thêm một ít xỉ than hoặc vỏ trấu hun
                        • pH từ 6.0-7.0
                        • Thoát nước cực tốt

                        Chăm sóc sau nhân giống:
                        • 2 tuần đầu: Tưới rất ít, chỉ phun sương nhẹ
                        • Tuần 3-4: Bắt đầu tưới nước bình thường
                        • Tháng đầu: Không bón phân
                        • Sau 1 tháng: Có thể bón phân loãng

                        Thời điểm tốt nhất:
                        • Mùa xuân (tháng 3-5): Lý tưởng nhất
                        • Đầu mùa hè (tháng 6): Cũng tốt
                        • Tránh mùa đông và giữa mùa hè

                        Dấu hiệu thành công:
                        • Lá xanh tươi, căng mọng
                        • Xuất hiện lá mới
                        • Rễ phát triển tốt
                        • Cây đứng vững`
                    }
                ...
                sections: [
                    {
                        ...
                        Nội dung video bao gồm:
                        • Cách di chuyển sen đá tránh mưa trực tiếp
                        • Kỹ thuật thoát nước và thông gió
                        • Phòng ngừa nấm bệnh trong môi trường ẩm ướt
                        • Điều chỉnh lịch tưới nước phù hợp
            ...
            content: {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        • Chậu to → lượng đất nhiều → giữ lại rất nhiều nước
                        • Cây nhỏ có nhu cầu nước ít
                        • Nước dư thừa gây úng rễ cho cây
                ...
                sections: [
                    {
                        ...
                        • Tốc độ phát triển: Nắng đủ = phát triển nhanh, thiếu nắng = chậm lớn
                        • Vẻ đẹp: Nắng đủ = màu sắc rực rỡ, thiếu nắng = xanh nhạt nhẽo
                        • Sức khỏe: Nắng đủ = cây chắc khỏe, thiếu nắng = yếu ớt dễ bệnh
                        • Hình dáng: Nắng đủ = cây cân đối, thiếu nắng = còng cong biến dạng

                        🔬 Cơ chế khoa học:
                        • Quang hợp: Tạo ra glucose - "thức ăn" cho cây
                        • Tổng hợp anthocyanin: Tạo màu đỏ, tím, cam đẹp mắt
                        • Điều hòa hormone: Kiểm soát sinh trưởng và phát triển
                        • Tăng cường miễn dịch: Sản xuất các hợp chất bảo vệ
                        ...
                        • Màu sắc và hình dáng cuối cùng
                        • Tuổi thọ và sức sống lâu dài`
                    },
                    {
                        ...
                        📸 Hình ảnh minh họa: [Cây sen đá đủ nắng, màu sắc đẹp](https://file.hstatic.net/1000187613/file/img_0014_58e1d51f0b4642649d412a3567d9b9e0_grande.jpg)
                        
                        🎨 Đặc điểm nhận biết:
                        • Màu sắc: Đẹp, rực rỡ, có nhiều sắc thái
                        • Lá mới ở giữa: Cân đối, không kéo dài bất thường
                        • Thân cây: Chắc khỏe, thẳng đứng, không còng
                        • Tổng thể: Gọn gàng, cân đối, hấp dẫn
                        • Độ căng mọng: Lá dày, cứng cáp, tươi tốt
                        • Khả năng kháng bệnh: Cao, ít bị sâu bệnh
                        
                        ❌ CÂY SEN ĐÁ THIẾU NẮNG:
                        
                        📸 Hình ảnh minh họa: [Cây sen đá thiếu nắng, màu sắc nhạt](https://file.hstatic.net/1000187613/file/bf68bd564664fd9c3a69b6402ef79d12_copy_grande.jpg)
                        
                        🚨 Dấu hiệu cảnh báo:
                        • Màu sắc: Nhạt, xanh lá cây đơn điệu, không đẹp
                        • Lá thưa: Khoảng cách giữa các lá lớn bất thường
                        • Thân cây: Kéo dài, còng cong, mất hình dáng
                        • Tổng thể: Mất cân đối, xấu xí, không thu hút
                        • Độ mềm: Lá mỏng, dễ gãy, thiếu sức sống
                        • Dễ bệnh: Thường xuyên bị sâu bệnh tấn công

                        ⚠️ Hậu quả lâu dài của thiếu nắng:
                        • Cây yếu ớt, dễ chết khi thay đổi môi trường
                        • Mất hoàn toàn giá trị thẩm mỹ và trang trí
                        • Khả năng sinh sản (ra con) rất kém
                        • Rất dễ nhiễm sâu bệnh, nấm mốc
                        • Gần như không thể phục hồi về dạng ban đầu
                    ...
                    },
                    {
                        ...
                        📸 Hình ảnh minh họa: [Phơi nắng đúng cách - có nắng trực tiếp rọi vào cây](https://file.hstatic.net/1000187613/file/img_0020_copy_grande.jpg)
                        
                        🌞 Đặc điểm nắng trực tiếp:
                        • Tia nắng chiếu thẳng: Ánh nắng mặt trời chiếu trực tiếp vào cây
                        • Có thể qua kính: Nắng qua cửa sổ kính vẫn hiệu quả tốt
                        • Tạo bóng rõ ràng: Cây tạo bóng đen, sắc nét trên mặt đất
                        • Cảm nhận được nhiệt: Khi chạm vào lá cây, cảm thấy ấm
                        • Thời gian tối thiểu: Cần ít nhất 4-6 giờ nắng trực tiếp/ngày

                        ❌ PHƠI NẮNG SAI CÁCH - CHỈ CÓ ÁNH SÁNG GIÁN TIẾP:
                        
                        📸 Hình ảnh minh họa: [Phơi nắng sai cách - nắng không trực tiếp rọi vào cây](https://file.hstatic.net/1000187613/file/img_0023_copy_grande.jpg)
                        
                        🌫️ Đặc điểm ánh sáng gián tiếp:
                        • Chỉ có ánh sáng: Sáng nhưng không có tia nắng trực tiếp
                        • Bóng mờ nhạt: Không tạo bóng rõ nét, chỉ có bóng mờ
                        • Không ấm: Lá cây không cảm nhận được nhiệt độ
                        • Ánh sáng tán xạ: Ánh sáng phản xạ từ tường, trần nhà
                        • Hiệu quả thấp: Hoàn toàn không đủ cho sen đá phát triển khỏe

                        🔬 So sánh chi tiết khoa học:
                        
                        | Yếu tố | Nắng trực tiếp ✅ | Ánh sáng gián tiếp ❌ |
                        |--------|-------------------|----------------------|
                        | Cường độ ánh sáng | 50,000+ lux | 1,000-5,000 lux |
                        | Nhiệt độ trên lá | Ấm, cảm nhận rõ | Mát, không ấm |
                        | Bóng của cây | Rõ nét, đen đậm | Mờ nhạt, không rõ |
                        | Hiệu quả cho cây | Cao, cây khỏe đẹp | Thấp, cây yếu xấu |
                        | Màu sắc cây | Đẹp, rực rỡ, đa dạng | Nhạt, xanh lá đơn điệu |
                        | Tốc độ phát triển | Nhanh, đều đặn | Chậm, không đều |

                        🏠 Đánh giá vị trí trong nhà:
                        • Tốt nhất: Sát cửa sổ hướng Nam, Đông (có nắng trực tiếp)
                        • Khá tốt: Gần cửa sổ hướng Tây (nắng chiều)
                        • Trung bình: Gần cửa sổ hướng Bắc (ít nắng trực tiếp)
                        • Rất kém: Giữa phòng, góc tối (chỉ có ánh sáng gián tiếp)
                        • Tệ nhất: Phòng không cửa sổ hoặc đèn điện
                ...
                sections: [
                    {
                        ...
                        content: `Xem video để học cách:
                        • Nhận biết rệp sáp trên sen đá
                        • Phương pháp xử lý bằng tay an toàn
                        • Sử dụng dung dịch xà phòng tự nhiên
                        • Cách phun thuốc sinh học hiệu quả
                        • Biện pháp phòng ngừa lâu dài

                        Những điều quan trọng trong video:
                        • Cách cách ly cây bị nhiễm ngay lập tức
                        • Kỹ thuật làm sạch từng kẽ lá
                        • Thời điểm xử lý tốt nhất trong ngày
                        • Tần suất kiểm tra và xử lý định kỳ`
                    },
                    {
                        ...
                        • Hình oval, dẹt, kích thước 2-5mm
                        • Có lớp sáp trắng phủ bên ngoài
                        • Di chuyển chậm chạp hoặc bám chặt

                        📍 Vị trí thường xuất hiện:
                        • Mặt dưới của lá
                        • Kẽ giữa các lá
                        • Gốc cây, thân cây
                        • Rễ trên mặt đất (ít gặp)

                        ⚠️ Dấu hiệu cây bị hại:
                        • Lá vàng, héo, rụng bất thường
                        • Xuất hiện chất nhầy trên lá
                        • Cây phát triển chậm lại
                        • Màu sắc lá nhạt đi, mất độ bóng

                        🕵️ Cách kiểm tra kỹ:
                        • Kiểm tra mặt dưới mỗi chiếc lá
                        • Dùng đèn pin chiếu để thấy rõ hơn
                        • Chú ý các vết trắng nhỏ di chuyển
                        • Tìm các đốm trắng bám chặt trên thân`
                    },
                    {
                        ...
                        🌡️ Điều kiện khí hậu:
                        • Nhiệt độ 25-30°C (môi trường trong nhà)
                        • Độ ẩm cao (60-80%)
                        • Không khí ít lưu thông
                        • Thiếu ánh sáng tự nhiên

                        🏠 Yếu tố môi trường:
                        • Cây đặt trong nhà kín
                        • Thiếu gió tự nhiên
                        • Quá nhiều cây đặt gần nhau
                        • Tưới nước quá nhiều tạo ẩm

                        🌱 Tình trạng cây:
                        • Cây yếu, sức đề kháng kém
                        • Bón phân quá nhiều đạm
                        • Cây mới mua chưa qua kiểm dịch
                        • Cây bị stress do thay đổi môi trường

                        🚪 Con đường lây nhiễm:
                        • Cây mới mua đã bị nhiễm
                        • Lây lan từ cây khác trong vườn
                        • Côn trùng mang theo từ bên ngoài
                        • Dụng cụ chăm sóc không sạch sẽ`
                    },
                    {
                        id: 'phuong-phap-xu-ly',
                        title: '🛠️ Phương Pháp Xử Lý Hiệu Quả',
                        content: `Bước 1: Cách ly ngay lập tức
                        • Tách cây bị nhiễm ra khỏi các cây khác
                        • Đặt ở nơi thoáng mát, có ánh sáng
                        • Không tưới nước trong 2-3 ngày đầu
                        • Chuẩn bị dụng cụ xử lý

                        Bước 2: Xử lý bằng tay (Cách đơn giản nhất)
                        • Dùng tăm bông tẩm cồn 70%
                        • Lau nhẹ từng con rệp trên lá
                        • Kiểm tra kỹ mặt dưới của lá
                        • Làm sạch hoàn toàn gốc và thân cây

                        Bước 3: Dung dịch xà phòng tự nhiên
                        Công thức:
                        • 1 thìa café xà phòng rửa chén
                        • 500ml nước ấm
                        • 1/2 thìa café dầu oliu (tùy chọn)

                        Cách sử dụng:
                        • Phun đều lên toàn bộ cây
                        • Chú ý phun mặt dưới lá
                        • Để 30 phút rồi xịt nước sạch
                        • Lặp lại 2-3 ngày/lần

                        Bước 4: Thuốc sinh học (Nếu cần)
                        • Dùng thuốc gốc neem oil
                        • Pha theo hướng dẫn nhà sản xuất
                        • Phun vào buổi chiều mát
                        • Tránh phun dưới nắng gắt

                        Bước 5: Theo dõi và kiểm tra
                        • Kiểm tra hàng ngày trong tuần đầu
                        • Xử lý ngay khi phát hiện rệp mới
                        • Tiếp tục cách ly 2-3 tuần
                        • Chỉ đưa cây về khi hoàn toàn sạch`
                    },
                    {
                        ...
                        Cách pha:
                        • Nghiền tỏi, ngâm nước 24h
                        • Lọc lấy nước, thêm xà phòng
                        • Phun 2 lần/tuần vào buổi chiều

                        2. Dung dịch dầu neem
                        Nguyên liệu:
                        • 10ml dầu neem nguyên chất
                        • 500ml nước ấm
                        • 5ml xà phòng tự nhiên
                        ...
                        • 2-3 quả ớt hiểm
                        • 500ml nước sôi
                        • 1 thìa café xà phòng

                        Cách làm:
                        • Ngâm ớt trong nước nóng 2h
                        • Lọc, thêm xà phòng
                        • Phun nhẹ, tránh vào mắt`
                    },
                    {
                        ...
                        • Đặt quạt nhỏ gần khu vực trồng cây
                        • Mở cửa sổ cho không khí lưu thông
                        • Không đặt quá nhiều cây gần nhau
                        • Tạo khoảng cách 15-20cm giữa các chậu

                        ☀️ Đảm bảo ánh sáng:
                        • Đặt cây gần cửa sổ có ánh sáng tự nhiên
                        • Xoay chậu định kỳ để cây nhận ánh sáng đều
                        • Sử dụng đèn LED grow light nếu cần
                        • Tránh để cây trong góc tối

                        💧 Quản lý độ ẩm:
                        • Tưới nước đúng cách, tránh úng
                        • Sử dụng khay sỏi để tăng độ ẩm tự nhiên
                        • Tránh phun nước lên lá thường xuyên
                        ...
                        • Hàng tháng: Kiểm tra kỹ từng cây
                        • Mùa hè: Tăng tần suất kiểm tra
                        • Sau mưa: Kiểm tra đặc biệt

                        🔍 Cách kiểm tra hiệu quả:
                        • Dùng kính lúp kiểm tra kẽ lá
                        • Chụp ảnh để so sánh theo thời gian
                        • Ghi chép tình trạng từng cây
                        • Đánh dấu cây đã kiểm tra

                        Tăng cường sức đề kháng:

                        🌱 Chăm sóc cây khỏe:
                        • Bón phân cân bằng, không quá đạm
                        • Đảm bảo cây có đủ ánh sáng
                        • Tưới nước đúng lượng, đúng thời điểm
                        • Thay đất định kỳ (1-2 năm/lần)

                        🧼 Vệ sinh dụng cụ:
                        • Rửa sạch dụng cụ sau mỗi lần dùng
                        • Khử trùng bằng cồn 70%
                        • Không dùng chung dụng cụ giữa các cây
                        • Rửa tay trước và sau khi chăm cây`
                    },
                    {
                        id: 'luu-y-quan-trong',
                        ...
                        • Tránh để dung dịch dính vào mắt
                        • Rửa tay sạch sau khi xử lý
                        • Làm việc ở nơi thoáng khí

                        🌱 Bảo vệ cây:
                        • Test dung dịch trên 1-2 lá trước
                        • Không xử lý dưới nắng gắt
                        • Tránh xử lý khi cây đang khô nước
                        • Cho cây nghỉ ngơi sau xử lý

                        Thời điểm xử lý tốt nhất:

                        🌅 Buổi sáng sớm (6-8h):
                        • Cây đã hồi phục sau đêm
                        • Nhiệt độ mát mẻ
                        • Ít gió, dung dịch không bay mất

                        🌆 Buổi chiều mát (16-18h):
                        • Tránh nắng gắt buổi trưa
                        • Cây có thời gian hồi phục qua đêm
                        • Độ ẩm không khí cao hơn

                        ❌ Tránh xử lý khi:
                        • Trời nắng gắt (10-15h)
                        • Mưa to gió lớn
                        • Cây vừa tưới nước
                        • Nhiệt độ quá cao (trên 35°C)

                        Dấu hiệu thành công:

                        ✅ Sau 1 tuần:
                        • Không thấy rệp sáp mới
                        • Lá bắt đầu tươi tóe hơn
                        • Cây không còn chất nhầy

                        ✅ Sau 2-3 tuần:
                        • Cây phát triển bình thường
                        • Màu sắc lá trở lại tự nhiên
                        • Không có dấu hiệu tái phát

                        🚨 Khi nào cần xử lý mạnh hơn:
                        • Rệp sáp lan rộng >50% cây
                        • Xử lý 2 tuần không hiệu quả
                        • Cây quá yếu, gần chết
                        • Lây lan sang nhiều cây khác
                ...
                sections: [
                    {
                        ...
                        • Nhận biết lá già cần loại bỏ
                        • Kỹ thuật tháo lá an toàn không làm tổn thương cây
                        • Cách nhổ cỏ dại mọc quanh gốc
                        • Vệ sinh chậu và bề mặt đất
                        • Sắp xếp lại cây sau khi vệ sinh

                        Link video: https://youtu.be/yEOihAe-ELE`
                    },
                    {
                        id: 'video-bo-sung',
                        title: '🎥 Video Bổ Sung: Kỹ Thuật Chuyên Sâu',
                        content: `Video chi tiết về vệ sinh lá già:
                        • Cách nhận biết lá già cần loại bỏ
                        • Kỹ thuật bứt lá nhẹ nhàng không làm tổn thương
                        • Thời điểm tốt nhất để vệ sinh
                        • Dụng cụ hỗ trợ an toàn
                        • Xử lý sau khi loại bỏ lá già

                        Link video: https://youtu.be/om9yZNcuwRs`
                    },
                    {
                        ...
                        • Rệp sáp thường ẩn náu dưới lá già
                        • Nấm mốc phát triển trong môi trường ẩm ướt
                        • Côn trùng nhỏ tìm chỗ trú ấn
                        • Vi khuẩn có thể xâm nhập từ lá thối

                        🌸 Cải thiện thẩm mỹ:
                        • Loại bỏ lá vàng, khô làm mất đẹp
                        • Giúp cây trông gọn gàng, sạch sẽ
                        • Tôn lên vẻ đẹp của lá mới
                        • Tạo hình dáng cây đẹp hơn

                        💪 Tăng sức khỏe cây:
                        • Cây tập trung dinh dưỡng cho lá mới
                        • Cải thiện thông gió quanh gốc
                        • Giảm nguy cơ nhiễm bệnh
                        • Kích thích cây phát triển tốt hơn`
                    },
                    {
                        id: 'nhan-biet-la-gia',
                        title: '🔍 Nhận Biết Lá Già Cần Loại Bỏ',
                        content: `📍 Vị trí lá già:
                        • Ở sát gốc cây, tầng lá dưới cùng
                        • Thường bị che khuất bởi lá mới
                        • Gần bề mặt đất
                        • Ít tiếp xúc với ánh sáng

                        🎨 Dấu hiệu nhận biết:
                        • Màu sắc: Vàng, nâu hoặc đã khô
                        • Độ mềm: Mềm nhũn, không còn căng mọng
                        • Kích thước: Co rúm, nhỏ hơn bình thường
                        • Bề mặt: Có đốm, nhăn nheo hoặc thối

                        ⏰ Thời điểm xuất hiện:
                        • Cây trưởng thành (trên 6 tháng tuổi)
                        • Sau khi thay chậu hoặc thay đất
                        • Mùa thay đổi thời tiết
                        • Khi cây ra lá mới nhiều

                        ❌ Lá KHÔNG nên loại bỏ:
                        • Lá còn xanh tươi
                        • Lá hơi vàng nhẹ nhưng còn cứng
                        • Lá đang trong quá trình chuyển màu tự nhiên
                        • Lá chỉ bị bụi bẩn (có thể lau sạch)`
                    },
                    {
                        id: 'ky-thuat-but-la',
                    ...
                    },
                    {
                        ...
                        • Cây mọc tự nhiên trong chậu
                        • Không phải sen đá (lá khác hẳn)
                        • Thường có rễ chính sâu
                        • Phát triển nhanh, cạnh tranh dinh dưỡng

                        🔧 Cách nhổ cỏ đúng:
                        • Tưới ẩm đất trước khi nhổ
                        • Cầm sát gốc cỏ, kéo thẳng lên
                        • Nhổ cả rễ, không để sót
                        • Dùng nhíp với cỏ nhỏ
                ...
                sections: [
                    {
                        ...
                        • Chuẩn bị dụng cụ chuyên nghiệp
                        • Chọn lá và cành phù hợp cho nhân giống
                        • Thiết lập hệ thống nhân giống bằng nước
                        • Theo dõi quá trình phát triển rễ từng ngày
                        • Chuyển cây con sang môi trường đất

                        Link video: https://youtu.be/5Iq2Acbm2PA`
                    },
                    {
                        id: 'video-nhan-giong-2',
                        title: '🎥 Video 2: Kỹ Thuật Nâng Cao',
                        content: `Video thứ hai hướng dẫn:
                        • Kỹ thuật nhân giống bằng nước chuyên sâu
                        • Sử dụng hormone kích thích ra rễ
                        • Tạo môi trường kiểm soát nhiệt độ và độ ẩm
                        • Xử lý các trường hợp đặc biệt
                        • Tips và tricks từ chuyên gia

                        Link video: https://youtu.be/5sz3NnTYJVg`
                    }
                ]
            }
        },
                ...
                sections: [
                    {
                        ...
                        • So sánh trực quan sen đá đủ nắng vs thiếu nắng
                        • Giải thích hiện tượng etiolation (vươn dài tìm sáng)
                        • Các dấu hiệu cảnh báo sớm
                        • Cách đo lường cường độ ánh sáng
                ...
                sections: [
                    {
                        ...
                        • Chú cừu béo đáng yêu đi lạc vào vườn
                        • Cuộc gặp gỡ bất ngờ với các chậu sen đá
                        • Những tình huống hài hước xảy ra
                        • Cái kết bất ngờ và ý nghĩa
                        • Bài học về sự hòa hợp trong tự nhiên`
                    }
                ]
            }
        },
                ...
                sections: [
                    {
                        ...
                        content: `http://file.hstatic.net/1000187613/article/he-little-white-strands-are-roots-now-i-know-why-my-succulent-has-them.jpg
                        ...
                        • Màu sắc: Thường màu trắng, hồng nhạt khi mới mọc
                        • Kích thước: Nhỏ li ti, dài 0.5-2cm
                        • Vị trí: Mọc rải rác trên thân, đặc biệt ở các đốt lá
                        • Số lượng: Từ vài rễ đến hàng chục rễ tùy mức độ

                        ⚖️ Đánh giá mức độ:
                        • Bình thường: Vài rễ nhỏ, cây vẫn khỏe mạnh
                        • Cảnh báo: Nhiều rễ xuất hiện đồng loạt
                        • Nguy hiểm: Rễ con kèm theo lá vàng, cây yếu ớt

                        🔬 Tại sao cây lại mọc rễ con?
                        Đây là cơ chế tự bảo vệ của sen đá khi:
                        • Hệ thống rễ chính không đáp ứng đủ nhu cầu
                        • Cây cần tìm kiếm nguồn nước/dinh dưỡng bổ sung
                        • Điều kiện môi trường không phù hợp
                        • Cây chuẩn bị cho việc nhân giống tự nhiên`
                    },
                    {
                        id: 'nguyen-nhan-1-thieu-nuoc',
                        title: '💧 Nguyên Nhân 1: Cây Bị Thiếu Nước',
                        content: `https://file.hstatic.net/1000187613/file/a-graptoveria-debbie-succulent-with-pink-aerial-roots_grande.jpg
                        ...
                        🌱 Về cây:
                        • Nhiều rễ li ti màu trắng/hồng nhạt trên thân
                        • Lá bắt đầu nhăn nheo, mềm nhũn
                        • Lá dưới cùng héo, khô trước
                        • Cây có vẻ "khát nước", kém sức sống

                        🌍 Về đất:
                        • Đất khô cứng, co rúm lại khỏi thành chậu
                        • Bề mặt đất nứt nẻ, cứng như đá
                        • Khi tưới, nước chảy xuống nhanh không thấm
                        • Dùng tăm tre đâm xuống đất hoàn toàn khô

                        💧 Giải pháp xử lý chi tiết:
                        
                        Bước 1: Tưới nước cấp cứu
                        • Tưới từ từ, nhiều lần nhỏ để đất thấm dần
                        • Tưới đến khi nước chảy ra lỗ thoát nước
                        • Đảm bảo toàn bộ khối đất được ướt đều

                        Bước 2: Điều chỉnh phương pháp tưới
                        • Nguyên tắc: Tăng lượng nước mỗi lần, KHÔNG tăng tần suất
                        • Cách kiểm tra: Dùng tăm tre đâm 3-5cm xuống đất
                        • Thời điểm tưới: Khi đất khô 70-80%
                        • Lượng nước: Tưới đến khi nước tràn ra đĩa lót

                        Sen đá cần được tưới nước nhiều hơn khi có rễ khí sinh
                        
                       https://file.hstatic.net/1000187613/file/you-may-need-to-water-your-succulents-more-if-you-notice-aerial-roots_grande.jpg
                    ...
                    },
                    {
                        ...
                        content: `Thân sen đá có nhiều rễ khí sinh do thiếu nắng
                        
                        https://file.hstatic.net/1000187613/file/a-succulent-stem-with-lots-of-aerial-roots_grande.jpg

                        🌱 Các loại sen đá dễ bị:
                        Trường hợp này thường gặp ở những loại cần nắng nhiều, điển hình là:
                        • Chi Sedum: Sen hồng mập, kim tuyến
                        • Chi Graptopetalum: Thạch ngọc mỹ, pha lê nâu
                        • Các hybrid: Đá cam, đá đỏ, đá vàng
                        • Loại khác: Các sen đá có màu đỏ, tím, cam

                        🔍 Hiện tượng kèm theo:
                        • Etiolation: Thân cao và vươn dài bất thường
                        • Rễ li ti: Xuất hiện nhiều trên thân kéo dài
                        • Màu sắc: Lá nhạt màu, mất sắc thái đẹp
                        • Khoảng cách lá: Xa nhau, không còn chặt chẽ
                        • Hướng nghiêng: Cây nghiêng về phía có ánh sáng

                        📸 Ví dụ cụ thể:
                        
                        https://file.hstatic.net/1000187613/file/graptopetalum-paraguayense-with-aerial-roots_grande.jpg
                        
                        https://file.hstatic.net/1000187613/file/graptoveria-fred-ives-with-air-roots_grande.jpg

                        🌞 Cách xử lý chi tiết:
                        
                        Bước 1: Đánh giá ánh sáng hiện tại
                        • Kiểm tra cây nhận được bao nhiêu giờ nắng trực tiếp/ngày
                        • Xác định có phải chỉ là ánh sáng gián tiếp không
                        • Quan sát bóng cây có rõ nét không

                        Bước 2: Tăng thời gian phơi nắng
                        • Di chuyển cây ra vị trí có nhiều nắng trực tiếp hơn
                        • Tăng dần thời gian phơi nắng (mỗi tuần thêm 1-2 giờ)
                        • Ưu tiên nắng sáng (6:00-10:00) an toàn nhất

                        Bước 3: Hỗ trợ bằng ánh sáng nhân tạo
                        • Dùng đèn LED grow light nếu thiếu nắng tự nhiên
                        • Đặt đèn cách cây 15-30cm
                        • Chiếu 12-14 giờ/ngày để bù đắp
                    ...
                    },
                    {
                        ...
                        https://file.hstatic.net/1000187613/file/home-design_grande.jpg
                        ...
                        Sen đá mọc rễ khí sinh khi thiếu nước
                        
                        https://file.hstatic.net/1000187613/file/rotinctum-frequently-grows-air-roots-when-it-isnt-getting-enough-water_grande.jpg
