...
import {createSupplier, getSupplierList, updateSupplier, updateSupplierStatus} from '../../services/ProductService.jsx';
            ...
            <Paper elevation={0} sx={{p: {xs: 2, md: 4}, borderRadius: 3, border: '1px solid #e5e7eb'}}>
                ...
                >
                    ...
                    <DialogContent sx={{px: 4, py: 3, bgcolor: '#fafafa'}}>
                        ...
                        <Paper elevation={0}
                               sx={{p: 3, borderRadius: 3, bgcolor: 'white', border: '1px solid #e5e7eb'}}>
                            <Box sx={{
                                display: 'flex',
