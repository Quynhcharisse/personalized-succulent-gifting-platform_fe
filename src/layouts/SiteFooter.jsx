      ...
      <div id="lien-he" className="footer__contact-section">
        <div className="container footer__contact-wrapper">
          <div className="footer__contact-left">
            <h2 className="elementor-heading-title elementor-size-default footer__contact-title">LIÊN HỆ NGAY</h2>
          </div>
          <div className="footer__contact-right">
            <form className="footer__contact-form elementor-form elementor-form-fields-wrapper elementor-labels-above" onSubmit={handleContactSubmit}>
              <input 
                type="text" 
                name="name" 
          ...
          <div className="footer__social">
            ...
            <a href="#" className="footer__social-link" aria-label="Shop">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25" fill="currentColor">
                <path d="M17,5.3h2.1c1.7,0,3.1,1.4,3.1,3.1l1,10.3c0,3.5-2.7,6.3-6.2,6.3H6.7c-3.4,0-6.2-2.8-6.2-6.2l1-10.5c0-1.7,1.4-3,3.1-3h2.1C6.7,2.4,9,0,11.9,0s5.2,2.3,5.2,5.2ZM16,7.3H4.6c-.6,0-1,.5-1,1l-1,10.5c0,2.3,1.9,4.1,4.2,4h10.4c2.3,0,4.2-1.9,4.2-4.2l-1-10.3c0-.6-.4-1.1-1-1.1h-3.1ZM8.7,5.3h6.2c0-1.7-1.4-3.1-3.1-3.1s-3.1,1.4-3.1,3.1ZM14.3,12.4c0,0-.2-.1-.3-.2-.1,0-.3-.2-.6-.3-.2,0-.5-.2-.7-.2-.3,0-.5-.1-.8-.1-.5,0-.8,0-1.1.3-.2.2-.3.4-.3.7s0,.4.2.6c.1.1.4.3.7.4.3,0,.7.2,1.1.3.6.1,1.1.3,1.5.5.4.2.8.5,1,.8.2.3.3.8.3,1.3s0,.9-.3,1.2c-.2.3-.4.6-.7.8-.3.2-.7.4-1,.5-.4,0-.8.1-1.2.1s-.9,0-1.3-.1c-.4,0-.9-.2-1.3-.4-.4-.2-.8-.4-1.1-.6l.8-1.5c0,0,.2.2.4.3.2.1.4.2.7.4.3.1.6.2.9.3.3,0,.7.1,1,.1s.8,0,1.1-.2c.2-.2.4-.4.4-.7s0-.5-.3-.6c-.2-.1-.5-.3-.8-.4-.3-.1-.7-.2-1.2-.4-.6-.2-1-.3-1.4-.5-.4-.2-.7-.4-.8-.7-.2-.3-.3-.7-.3-1.1s.1-1.1.4-1.5c.3-.4.7-.7,1.2-.9.5-.2,1-.3,1.6-.3s.8,0,1.2.1c.4,0,.7.2,1,.4.3.1.6.3.9.5l-.8,1.4Z"/>
              </svg>
            </a>
